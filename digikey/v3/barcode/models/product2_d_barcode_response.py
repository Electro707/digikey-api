...
class Product2DBarcodeResponse(object):
    ...
    def __init__(self, digi_key_part_number=None, manufacturer_part_number=None, manufacturer_name=None, product_description=None, quantity=None, salesorder_id=None, invoice_id=None, purchase_order=None, country_of_origin=None, lot_code=None, date_code=None):  # noqa: E501
